...
int main()
{
    ...
    qn = new QuadNode<int>(0,0,0,0);// qn = [_,_,2,1]
...
//    qn->son(SE) = new QuadNode<int>(0,0,qn->son(SE),0);
    qn->son(NW) = new QuadLeaf<int>(6);                // qn = [6,_,2,3]
    qn->son(SW) = new QuadLeaf<int>(4);// qn = [[_,_,_,6],_,2,3]
    qn->son(NE) = new QuadLeaf<int>(7);                // qn = [[_,_,_,6],7,2,4]
    qn->son(SE) = new QuadNode<int>(0,0,0,0);                                             // qn = [[_,_,_,6],7,[_,_,2,_],4]
